...
int main() {
	...
	for(int row = 0; row < h; row+=2) 
    {
        ...
        {
            // in order to find the average we need to be able to divide by the amount of numbers 
            // and make sure there is no remainder 
         int average = (img[row][col]+img[row][col+1]+img[row+1][col]+img[row+1][col+1])/4;
