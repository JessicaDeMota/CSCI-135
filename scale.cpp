...
int main() {
	...
	for(int row = 0; row < h; row++) {
        ...
        //in order to make an image increase by scale you must understand that an image 
        // has to increase by the row double size and the columns as well 
        // scaling by 200 is the same as a 4x4 you need the rows to increase as well. 
        {
